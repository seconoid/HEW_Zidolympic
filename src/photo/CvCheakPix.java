...
public class CvCheakPix {
	public static int a(String filename){
		...
		Mat im = Imgcodecs.imread("C:\\Users\\nakayama.akito\\workspace_jv11\\HEW_Zidolympic\\WebContent\\UploadImages\\"+filename);											// 入力画像の取得
		Mat hsv = new Mat();
		Mat mask = new Mat();
		Mat im2 = new Mat();
		...
		Imgcodecs.imwrite("C:\\Users\\nakayama.akito\\workspace_jv11\\HEW_Zidolympic\\WebContent\\UploadImages\\cvTest100.png", im2);					//cvtest100.jpgとして書き出し
