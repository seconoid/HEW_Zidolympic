...
public class CvCheakPix {
	public static int a(){
		...
		Mat im = Imgcodecs.imread("C:\\Users\\yusuke-01\\workspace_JV11\\HEW_Zidolympic\\WebContent\\UploadImages\\test0.png");											// 入力画像の取得
		Mat hsv = new Mat();
		Mat mask = new Mat();
		Mat im2 = new Mat();
		...
		Imgcodecs.imwrite("C:\\Users\\yusuke-01\\workspace_JV11\\HEW_Zidolympic\\WebContent\\UploadImages\\test2.png", im2);					//test2.jpgとして書き出し
